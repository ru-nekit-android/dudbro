	...
	for (ifa = ifAddrStruct; ifa != NULL; ifa = ifa->ifa_next) 
	{
        ...
        {  
            ...
            if (flag)
            {
                ...
                FRENewObject(
                             (const uint8_t*)"ru.nekit.ane.NetworkInfo.NetworkInterface",
                             6,
...
{ 
	...
	if (FRE_OK != 
        FRENewObject((const uint8_t*)"ru.nekit.ane.NetworkInfo.InterfaceAddress", 4, InterfaceAddrsArray, &Addrstemp, nil))
    {

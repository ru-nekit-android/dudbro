...
package spark.skins.ios
{
	...
	import spark.skins.ios160.assets.ButtonBarFirstButton_up;
	...
	public class ButtonBarFirstButtonSkin extends ButtonBarButtonSkinBase
	{
		...
		public function ButtonBarFirstButtonSkin()
		{
			...
			{
			spark.skins.mobile320.assets.ButtonBarFirstButton_selected
			...
			upBorderSkin = spark.skins.ios160.assets.ButtonBarFirstButton_up;
